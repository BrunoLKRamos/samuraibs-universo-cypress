...
describe('cadastro', function () {
    ...
    context('quando o usuário é novato', function () {
        const user = { name: 'Bruno Ramos', email: 'bruno@samuraibs.com', password: 'pwd123' }
    ...
    context('quando o e-mail já existe', function () {
        const user = { name: 'Bruno Luis', email: 'brunol@samuraibs.com', is_provider: true, password: 'pwd123' }
    ...
    context('quando o e-mail é incorreto', function () {
        const user = { name: 'Elizabeth Olsen', email: 'liza.yahoo.com', password: 'pwd123' }
